      ...
      select case(self%kind)
        case("sp")
          if (self%layered) then
            ...
            call self%nc%setData(buffer_sp)
        ...
        case("dp")
          if (self%layered) then
            ...
            call self%nc%setData(buffer_dp)
        ...
        case("i1")
          if (self%layered) then
            ...
            call self%nc%setData(buffer_i1)
        ...
        case("i2")
          if (self%layered) then
            ...
            call self%nc%setData(buffer_i2)
        ...
        case("i4")
          if (self%layered) then
            ...
            call self%nc%setData(buffer_i4)
        ...
        case("i8")
          if (self%layered) then
            ...
            call self%nc%setData(buffer_i8)
